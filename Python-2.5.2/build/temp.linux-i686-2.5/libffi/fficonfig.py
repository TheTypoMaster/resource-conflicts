...
ffi_srcdir = '/home/tchakra2/seq-sat-lama/Python-2.5.2/Modules/_ctypes/libffi'
ffi_sources += ffi_platforms['X86']
ffi_sources = [os.path.join('/home/tchakra2/seq-sat-lama/Python-2.5.2/Modules/_ctypes/libffi', f) for f in ffi_sources]
