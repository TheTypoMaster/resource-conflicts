(define
	...
	(:predicates
		...
		( EXPLAINED_MOVE_HUMAN_ROOM2_HALL2_1 )
		( EXPLAINED_MOVE_HUMAN_HALL2_HALL3_1 )
		( EXPLAINED_CONDUCT_TRIAGE_HUMAN_HALL3_1 )
	...
	(:action EXPLAIN_OBS_MOVE_HUMAN_ROOM2_HALL2_1
		:parameters ()
		:precondition
		(and
			( AT_HUMAN_ROOM2 )
		...
		(and
			...
			( AT_HUMAN_HALL2 )
			 ( EXPLAINED_MOVE_HUMAN_ROOM2_HALL2_1 )
			(not ( AT_HUMAN_ROOM2 ))
			 (not ( NOT_EXPLAINED_MOVE_HUMAN_ROOM2_HALL2_1 ))
		)
	)
	...
	(:action EXPLAIN_OBS_MOVE_HUMAN_HALL2_HALL3_1
		:parameters ()
		:precondition
		(and
			( AT_HUMAN_HALL2 )
		...
		(and
			...
			( AT_HUMAN_HALL3 )
			 ( EXPLAINED_MOVE_HUMAN_HALL2_HALL3_1 )
			(not ( AT_HUMAN_HALL2 ))
			 (not ( NOT_EXPLAINED_MOVE_HUMAN_HALL2_HALL3_1 ))
		)
	)
	...
	(:action EXPLAIN_OBS_CONDUCT_TRIAGE_HUMAN_HALL3_1
		:parameters ()
		:precondition
		(and
			( HAS_MEDKIT_HUMAN )
		...
		(and
			...
			( CONDUCTED_TRIAGE_HUMAN_HALL3 )
			 ( EXPLAINED_CONDUCT_TRIAGE_HUMAN_HALL3_1 )
			 ( EXPLAINED_FULL_OBS_SEQUENCE )
			 (not ( NOT_EXPLAINED_CONDUCT_TRIAGE_HUMAN_HALL3_1 ))
